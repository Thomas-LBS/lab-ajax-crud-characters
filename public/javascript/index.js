...
window.addEventListener('load', () => {
  ...
  .addEventListener('click', function (event) {
    ...
    charactersAPI.getOneRegister(characterId)
      ...
      .catch(error=>console.error('Error while getOneRegister', error.message))  
  })
  ...
  .addEventListener('click', function (event) {
    ...
    charactersAPI.deleteOneRegister(characterId)
      ...
      .catch(error=>{
        document.querySelector('#delete-one').style.backgroundColor = "red"
        console.error('Error while deleteOneRegister', error.message)  
      })
  })
  ...
  event.preventDefault()
    ...
    if (name === '' || occupation === '' || weapon === ''){
      ...
      throw new Error ('Name, Occupation and Weapon are mandatory')  
    }
  ...
  .addEventListener('submit', function (event) {
    event.preventDefault()
      ...
      if (id === ""){
        ...
        throw new Error ('Please enter the ID to edit')  
      }
